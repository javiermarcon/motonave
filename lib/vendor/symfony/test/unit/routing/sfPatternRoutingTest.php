...
class sfPatternRoutingTest extends sfPatternRouting
{
  public function initialize(sfEventDispatcher $dispatcher, sfCache $cache = null, $options = array())
  {
    ...
    $this->options['context']['host'] = '127.0.0.1';
  }
...
$t->is($r->generate('', array('module' => 'foo', 'action' => 'bar')), 'http://127.0.0.1/foo/bar', '->generate() allows route to generate absolute urls');
$t->is($r->generate('', array('module' => 'foo', 'action' => 'bar'), true), 'http://127.0.0.1/foo/bar', '->generate() does not double-absolutize urls');
