...
$t->is(_compute_public_path('foo', 'css', 'css', true), 'http://127.0.0.1/css/foo.css', '_compute_public_path() can create absolute links');
...
$t->is(image_tag('test', array('absolute' => true)), '<img src="http://127.0.0.1/images/test.png" />', 'image_tag() can take an absolute parameter');
...
$t->is(stylesheet_tag('style', array('absolute' => true)), 
  '<link rel="stylesheet" type="text/css" media="screen" href="http://127.0.0.1/css/style.css" />'."\n", 
...
$t->is(javascript_include_tag('xmlhr', array('absolute' => true)),
  '<script type="text/javascript" src="http://127.0.0.1/js/xmlhr.js"></script>'."\n", 
...
$t->is(javascript_path('xmlhr.foo', true), 'http://127.0.0.1/js/xmlhr.foo', 'javascript_path() accepts a second parameter to output an absolute resource path');
...
$t->is(stylesheet_path('style.foo', true), 'http://127.0.0.1/css/style.foo', 'stylesheet_path() accepts a second parameter to output an absolute resource path');
...
$t->is(image_path('img.jpg', true), 'http://127.0.0.1/images/img.jpg', 'image_path() accepts a second parameter to output an absolute resource path');
