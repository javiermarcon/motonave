...
$t->like($response->getContent(), '~http\://127.0.0.1/index.php/\?module=module&amp;action=action&amp;id=1#photos~', '->redirect() adds a refresh meta in the content');
$t->like($response->getHttpHeader('Location'), '~http\://127.0.0.1/index.php/\?module=module&action=action&id=1#photos~', '->redirect() adds a Location HTTP header');
